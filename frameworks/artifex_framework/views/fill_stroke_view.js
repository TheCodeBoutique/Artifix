ART.FillStrokeView = SC.View.extend({
  ...
  backgroundColorIdentifierFrame: SC.View.design({
    ...
    backgroundColorIdentifier: SC.View.design(ART.CSSGenerator,{
      backgroundColorBinding: "Artifex.partsController.backgroundColor",
      layout: { top: 3, right: 3, bottom: 3, left: 3},
      cssStyle:"background",
      mouseDown:function(evt) {
        Artifex.statechart.sendEvent('doShowColorPicker', {event:"background"});
      }
    }),
  ...
  strokeColorIdentifierFrame: SC.View.design({
    ...
    strokeColorIdentifier: SC.View.design({
      backgroundColorBinding: "Artifex.partsController.strokeColor",
      layout: { top: 3, right: 3, bottom: 3, left: 3},
      mouseDown:function(evt) {
        Artifex.statechart.sendEvent('doShowColorPicker', {event:"stroke"});
      }
    })
  }),
