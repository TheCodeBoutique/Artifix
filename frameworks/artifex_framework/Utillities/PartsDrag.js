...
ART.PartsDrag = {
   ...
   */
  isAnchoredBinding: SC.Binding.oneWay("Artifex.partsController.isMovementLocked"),
  isAnchoredSetBinding: SC.Binding.oneWay("Artifex.partsController.isAnchoredSet"),
