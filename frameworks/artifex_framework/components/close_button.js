...
/** @class
  ...
  The ART.CloseButtonView is used within the TCB.InspectorPane.  Its purpose is to close the inspector pane.  One would not use this button on its own.
  Rather, the TCB.InspectorPane comes standered with it when appended to the DOM.
  ...
  @author Chad Eubanks
*/
ART.CloseButtonView = SC.View.extend(
/** @scope TCB.CloseButtonView.prototype */ {
  ...
  */
  action: function(evt) {
	  console.log("close");
      this.getPath('.parentView').remove();
      return YES;
  },
  ...
  /**
     ...
     @readOnly
   */
   ariaRole: 'close inspector button',
